# Explicación: Distribuye los elementos en varios cubos (buckets), luego ordena cada cubo individualmente (usando otro algoritmo o recursivamente) y finalmente concatena los resultados.
